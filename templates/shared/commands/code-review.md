...
Follow all patterns from `./codegen/rules/subagents/code-review.md` — PROACTIVELY SCAN for ALL violation patterns.
...
4. **Apply all review patterns** from `./codegen/rules/subagents/code-review.md` systematically:
...
6. **Generate comprehensive report** per format in `./codegen/rules/subagents/code-review.md`:
