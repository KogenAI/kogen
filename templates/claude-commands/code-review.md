...
**CRITICAL**: Follow all patterns and requirements from `./codegen/rules/code-review.md` - Do NOT wait for user guidance. PROACTIVELY SCAN for ALL violation patterns.

1. **Load code review rules** - Read `./codegen/rules/code-review.md` for comprehensive review patterns
...
4. **Apply all code review patterns** - Follow `./codegen/rules/code-review.md` systematically:
...
6. **Generate comprehensive report** - Following the format specified in `./codegen/rules/code-review.md`:
