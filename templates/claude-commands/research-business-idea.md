...
Clear, concise vision statement

## Core Problem

- Bullet points of key problems being solved
...
- Main user workflow and features

### Platform-Specific Features

- Mobile, web, API considerations
...
- Primary and secondary monetization

### Pricing Strategy

- Free/paid tiers, subscription models
...
Table comparing key competitors with:
...
- Minimum viable features for testing
...
- Advanced features and market capture

## User Psychology Insights

### Why Users Choose Alternatives

- Research-backed user preferences

### Retention Strategies

- Methods to keep users engaged

## Technical Feasibility

### API/Service Constraints

- Limitations and costs discovered
...
- Revenue and growth measurements
