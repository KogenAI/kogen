...
LLM_PATHS_REGEX="(claude_runner_impl|claude_build_runner_impl|bouncer\\.ex|system_prompts|CLAUDE\\.md|codegen/rules/|codegen/recipes/|\\.md\\.j2\$|llm_integration.*\\.exs)"
