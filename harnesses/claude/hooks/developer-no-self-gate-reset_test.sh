...
SID1="reset-test-1-$$"
COUNTER1="/tmp/combobulate-self-gate-${SID1}.count"
printf '2' >"$COUNTER1"
...
SID2="reset-test-2-$$"
COUNTER2="/tmp/combobulate-self-gate-${SID2}.count"
printf '1' >"$COUNTER2"
...
SID3="reset-test-3-$$"
COUNTER3="/tmp/combobulate-self-gate-${SID3}.count"
printf '3' >"$COUNTER3"
...
SID4="reset-test-4-$$"
COUNTER4="/tmp/combobulate-self-gate-${SID4}.count"
printf '2' >"$COUNTER4"
...
SID5="reset-test-5-$$"
COUNTER5="/tmp/combobulate-self-gate-${SID5}.count"
rm -f "$COUNTER5"
...
SID6="reset-test-6-$$"
COUNTER6="/tmp/combobulate-self-gate-${SID6}.count"
printf '1' >"$COUNTER6"
