...
# rationale: Claude SubagentStop can block a spinning developer subagent; Pi's session_shutdown-equivalent has no comparable block-capable SubagentStop event for this check
