...
| `context/rules-stacks.md`      | Stack-specific and cross-stack rules | phoenix rules, static rules, git-readonly, config-single-source, hook-layering, LiveView patterns, ExUnit, Oban, migrations | shared/rules/stacks/phoenix/*, stacks/static/*, shared/rules/shared/*       |
