...
## Second failure revision — 2026-09-14

The Shaper requested “so why didn't you fix the Intent?” and recording the related evidence in same-build-refresh. This authorizes package revision, not renewed approval. Strengthen the existing self-build transition with loaded-controller lifetime and actual initial/resumed consumer checks; preserve fail-closed state admission. No general refresh or extra allowance is added. See evidence/transition-failure/README.md.
