...
Start with [the contract](INTENT.md), then [scenarios](scenarios.yaml), [risks and ownership](risks.yaml), and [decision provenance](decisions.md). [intent.yaml](intent.yaml) owns current identity and approval metadata. Earlier approvals remain historical; intent.yaml records approval of the expanded current contract. [questions.md](questions.md) records question disposition.
