...
Only the committer role makes git commits, and only after the reviewer approves and the gate is clear. Commit messages are why-focused — never include the gate command, test output, or CI status.
