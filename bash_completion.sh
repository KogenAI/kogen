...
_codegen_completion() {
    ...
    if [[ ${COMP_CWORD} == 1 ]]; then
        local opts="ai-config bird-eye clean clean-branches clean-servers consolidate-context help ls new plan prepare prune remove-comments resources resume rm setup update-context"
