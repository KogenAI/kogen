...
Tests live under `test_harness/test/stacks/` organized by stack (phoenix, static). The library code in `test_harness/lib/codegen_test_harness/` provides shared helpers.
