...
| File                                                     | Purpose                                                            |
| -------------------------------------------------------- | ------------------------------------------------------------------ |
| `shared/recipes/static-html-base-template.md`            | Base HTML + Tailwind v4 page structure for plain HTML static sites |
...
- **scaffold**: scaffold templates reference recipes for standard patterns (e.g. `static-html-base-template.md` used in plain HTML scaffolding)
