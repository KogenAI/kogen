...
| env-var-sample-scan              | hook-lib       | `harnesses/claude/hooks/lib/env-var-sample-scan.sh` | `harnesses/claude/hooks/lib/env-var-sample-scan_test.sh` | Extracted for reuse by loop `run_env_var_step`; 10 test cases (A–J, Tests I–J: defaulted-read exemption) |
