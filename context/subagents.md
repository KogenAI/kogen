...
shared/subagents/
  ...
  shared/
    ...
    spike-builder.md.j2  ← designed for shape mode, also reachable from debug mode; sandboxed to codegen/pitches/ + absolute /tmp/
```
