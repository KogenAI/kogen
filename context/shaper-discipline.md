...
| G    | Decompose-then-split     | Shaper SPLITS too-large problem into N pitches; never asks user "should I split?". Before splitting, rule H outcome (e) runs first: one-purpose pieces collapse (not split). Chat: `Decomposed: extracted <slug-1>, <slug-2> …`. Only split Qs reaching user are genuine product forks.                                                                                                                                                                                                                                                                                                                 |
