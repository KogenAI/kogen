...
├── CLAUDE.md                     ← codegen session loop docs (committed; hand-authored sibling to AGENTS.md, same content, different import syntax)
...
| `CLAUDE.md`          | AI sessions (claude render)    | Same content as AGENTS.md; `@context/...` import syntax     | Committed; hand-authored |
...
- [ ] **CLAUDE.md and AGENTS.md are both hand-authored siblings and BOTH committed** — identical content, different import syntax (`→ See` prose in AGENTS.md; `@context/...` auto-imports in CLAUDE.md).
