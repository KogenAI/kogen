...
| `codegen-document` | Generates/refreshes `shared/usage_rules/<lib>-<version>.md` machine-generated hex library API summaries                                                                                                                                                                             | Contributors adding/updating a hex dependency                 |
...
| `harnesses/claude/hooks/`                         | 64 hook scripts (PreToolUse, SubagentStop, Stop) + paired `_test.sh` + `lib/`            |
