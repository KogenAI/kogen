...
**Not-yet-migrated hooks:** migration is complete — no current outliers. `registry.yaml`'s header comment (§ NOT-YET-MIGRATED) is the single authoritative note on this state.
